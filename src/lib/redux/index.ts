import {applyMiddleware, createStore, compose, Middleware, Action, AnyAction, Store, StoreEnhancer, DeepPartial} from 'redux'
...
export default function configureStore<S = any, A extends Action = AnyAction>(preloadedState?: DeepPartial<S>): Store {
